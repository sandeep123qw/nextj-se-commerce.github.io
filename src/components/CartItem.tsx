...
const CartItem = () => {
  ...
  return (
    <div className="flex flex-col gap-y-2">
      <div className="hidden lg:inline-flex items-center justify-between font-semibold bg-white p-2 shadow-lg">
      ...
      <div className="flex flex-col gap-y-2 ">
        {productData?.map((item: Products) => (
          <div
            key={item._id}
            className="w-full bg-white p-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-lg"
          >
